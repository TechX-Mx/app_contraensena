import 'package:contraensena/src/pages/login/login_controller.dart';
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(
          ...
          fit: BoxFit.fill, // Adjust the image size to cover the container
        ),
      ),
      child: Column(
        mainAxisAlignment: MainAxisAlignment.end,
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      enabledBorder: OutlineInputBorder(
                        borderSide:
                            BorderSide(width: 1, color: ColorsApp.white),
                ...
                Padding(
                  ...
                  child: MaterialButton(
                    ...
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(5.0),
                        side: BorderSide(color: ColorsApp.white, width: 1.0)),
                    child: Text(
                      'Ingresar',
                      style: TextStyle(
                          fontFamily: 'Georgia',
